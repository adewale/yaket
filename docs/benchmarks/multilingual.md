...
- `top`: 10, max n-gram: 3
- Python YAKE available: yes

## Parity Summary

| Language | Yaket runtime (ms) | Head match (leading exact prefix) | Top-K overlap |
|---|---:|---:|---:|
| English (`en`) | 4.23 | 10/10 | 10/10 |
| German (`de`) | 1.02 | 10/10 | 10/10 |
| Spanish (`es`) | 1.26 | 9/10 | 9/10 |
| French (`fr`) | 0.73 | 10/10 | 10/10 |
| Italian (`it`) | 0.68 | 10/10 | 10/10 |
| Portuguese (`pt`) | 0.87 | 10/10 | 10/10 |
| Dutch (`nl`) | 0.76 | 10/10 | 10/10 |
| Russian (`ru`) | 3.13 | 10/10 | 10/10 |
| Arabic (`ar`) | 0.57 | 0/10 | 10/10 |

## Per-language results

### English (`en`)

Yaket runtime: 4.23 ms

**Yaket top keywords**

- Cloudflare Workers run
- Workers run JavaScript
- Cloudflare Workers
- close to users
- Workers run
- run JavaScript
...
- Workers
- edge runtimes shrink
- Modern edge

**Python YAKE top keywords**
...
Leading exact-match prefix: 10
Top-10 set overlap: 10

### German (`de`)

Yaket runtime: 1.02 ms
...
Leading exact-match prefix: 9
Top-10 set overlap: 9

### French (`fr`)

Yaket runtime: 0.73 ms
